...
public class Response implements org.apache.thrift.TBase<Response, Response._Fields>, java.io.Serializable, Cloneable, Comparable<Response> {
  ...
  public MessageBody result; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULT, new org.apache.thrift.meta_data.FieldMetaData("result", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, MessageBody.class)));
  ...
  public Response(Response other) {
    ...
    if (other.isSetResult()) {
      this.result = new MessageBody(other.result);
    }
  }
   ...
   * @see StatusCode
   */
  public Response setRCode(StatusCode rCode) {
    this.rCode = rCode;
    return this;
  }
  ...
  public Response setResult(MessageBody result) {
    this.result = result;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // R_CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.rCode = javal.thrift.rpc.StatusCode.findByValue(iprot.readI32());
