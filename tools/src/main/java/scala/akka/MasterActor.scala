...
import scala.akka.Messages._
import scala.akka.MasterServer.workerMap
...
import scala.akka.Messages.{Heartbeat, RegisterWorker}
...
class MasterActor() extends Actor with ActorLogging {
    //超时时间
    val CHECK_INTERVAL: Int = LoadPropers.getProperties("akka").getProperty("akka.check.interval", "30000").toInt
